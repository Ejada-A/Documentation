...
Moreover, we found no Stripe webhook handler in \texttt{payments-service} or
elsewhere in the repositories at the reviewed commits. However, our subsequent remediation added Stripe
