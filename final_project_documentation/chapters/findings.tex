...
Figure~\ref{fig:app-access} narrows in on the application layer: the Ingress
Controller's path-based routing to each of the five workloads, and the shared MongoDB
instance every one of them, including the frontend itself, connects to directly.
